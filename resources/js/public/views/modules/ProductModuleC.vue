        ...
        <Transition name="fade-slide-up">
          <div class="w-full mt-8 px-2 sm:px-4">
            ...
            <p class="text-gray-800 text-sm sm:text-base text-justify leading-relaxed">
              This is the overview for Product Module C. Detailed product specifications and features would be displayed here.
            </p>
          </div>
        </Transition>
            ...
            <div class="flex-1">
              ...
              <div class="overflow-x-auto">
                <table class="table-auto w-full text-sm text-gray-700 border-collapse">
                  <tbody>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Memory</td>
                      <td class="border-b border-gray-800 px-2 py-2">16GB Flash, 4GB RAM</td>
                    </tr>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Ports</td>
                      <td class="border-b border-gray-800 px-2 py-2">4x 10G SFP+, 48x 1G RJ45</td>
                    </tr>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Power</td>
                      <td class="border-b border-gray-800 px-2 py-2">Redundant 1200W AC</td>
                    </tr>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Dimensions</td>
                      <td class="border-b border-gray-800 px-2 py-2">1.5U Rack Mount</td>
                    </tr>
                  </tbody>
                </table>
              </div>
