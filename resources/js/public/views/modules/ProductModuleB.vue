        ...
        <Transition name="fade-slide-up">
          <div class="w-full mt-8 px-2 sm:px-4">
            ...
            <p class="text-gray-800 text-sm sm:text-base text-justify leading-relaxed">
              This is the overview for Product Module B. Detailed product specifications and features would be displayed here.
            </p>
          </div>
        </Transition>
            ...
            <div class="flex-1">
              ...
              <div class="overflow-x-auto">
                <table class="table-auto w-full text-sm text-gray-700 border-collapse">
                  <tbody>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Performance</td>
                      <td class="border-b border-gray-800 px-2 py-2">High-speed processing capabilities</td>
                    </tr>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Connectivity</td>
                      <td class="border-b border-gray-800 px-2 py-2">Gigabit Ethernet ports</td>
                    </tr>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Security</td>
                      <td class="border-b border-gray-800 px-2 py-2">Advanced encryption protocols</td>
                    </tr>
                    <tr>
                      <td class="font-semibold border-b border-r border-gray-800 px-2 py-2">Management</td>
                      <td class="border-b border-gray-800 px-2 py-2">Web-based interface</td>
                    </tr>
                  </tbody>
                </table>
              </div>
