        ...
        <header class="bg-gray-800 text-white sticky top-0 z-50">
            <div class="container mx-auto px-4 py-3">
                <div class="flex justify-between items-center">
                    ...
                    <nav class="hidden md:flex space-x-6">
                        ...
                        <a href="/products" class="hover:text-blue-400 transition">Product</a>
            ...
            <div id="mobile-menu" class="md:hidden bg-gray-700 hidden">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    <a href="/" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-600">Home</a>
                    <a href="/products" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-600">Product</a>
                    <a href="/solutions" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-600">Solutions</a>
                    <a href="/projects" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-600">Projects</a>
                    <a href="/contact" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-600">Contact</a>
                </div>
            </div>
        </header>
        ...
        <footer class="bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200 py-10 px-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 w-full text-sm">
                    <div>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li><a href="/solutions" class="hover:underline">Service & Solutions</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-1">
                            <li><a href="/products" class="hover:underline">OLT</a></li>
                            <li><a href="/products" class="hover:underline">ONU</a></li>
                            <li><a href="/products" class="hover:underline">ONU PoE</a></li>
                            <li><a href="/products" class="hover:underline">ONT</a></li>
                            <li><a href="/products" class="hover:underline">SWITCH</a></li>
                            <li><a href="/products" class="hover:underline">PoE Switch</a></li>
                            <li><a href="/products" class="hover:underline">Wireless</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-gray-900 dark:text-gray-100 font-semibold uppercase tracking-tight mb-2 border-b-2 border-gray-300 dark:border-gray-700 pb-2">
                        ...
                        <ul class="space-y-1">
                            <li><a href="/solutions" class="hover:underline">Managed Services</a></li>
                            <li><a href="/solutions" class="hover:underline">Maintenance and Support</a></li>
                            <li><a href="/solutions" class="hover:underline">Design and Build</a></li>
                            <li><a href="/solutions" class="hover:underline">Training Dasan Product</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-gray-900 dark:text-gray-100 font-semibold uppercase tracking-tight mb-2 border-b-2 border-gray-300 dark:border-gray-700 pb-2">
                        ...
                        <ul class="space-y-1">
                            <li><a href="/projects?id=ispcustomer" class="hover:underline">ISP Partner</a></li>
                            <li><a href="/projects?id=managedservices" class="hover:underline">Managed Service</a></li>
                            <li><a href="/projects?id=fttxproject" class="hover:underline">FTTx Project</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-gray-900 dark:text-gray-100 font-semibold uppercase tracking-tight mb-2 border-b-2 border-gray-300 dark:border-gray-700 pb-2">
            ...
            <div class="max-w-screen-xl mx-auto mt-10 pt-6 border-t border-gray-300 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4 text-sm px-4">
                <p class="text-gray-600 dark:text-gray-400 text-center md:text-left">
                    &copy; {{ date('Y') }} Moimstone Dasan Indonesia. All rights reserved.
                </p>
