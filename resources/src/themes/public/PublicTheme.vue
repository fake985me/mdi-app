    ...
    <header class="bg-gray-800 text-white sticky top-0 z-50">
      <div class="container mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
          ...
          <nav class="hidden md:flex space-x-6">
            ...
            <a href="/product" class="hover:text-blue-400 transition">Product</a>
      ...
      <div v-if="mobileMenuOpen" class="md:hidden bg-gray-700">
        <div class="px-2 pt-2 pb-3 space-y-1">
          ...
          <a href="/product" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-600">Product</a>
      ...
      <div class="max-w-screen-xl mx-auto px-6 flex flex-col md:flex-row md:justify-between gap-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 w-full text-sm">
          <div v-for="section in footerSections" :key="section.title">
            ...
            <div v-else-if="section.customHtml" v-html="section.customHtml"></div>
          </div>
        </div>
      </div>
    ...
    icon: {
      render() {
        return h('svg', {
          fill: 'currentColor',
          viewBox: '0 0 24 24',
          innerHTML: '<path d="M22 12A10 10 0 1 0 10 21.9V14.89h-2.5v-3H10V9.75c0-2.5 1.49-3.88 3.77-3.88 1.09 0 2.24.19 2.24.19v2.47h-1.26c-1.25 0-1.64.78-1.64 1.57v1.88h2.78l-.44 3H13.1v7.01A10 10 0 0 0 22 12Z"/>',
        })
      },
    }
  },
    ...
    icon: {
      render() {
        return h('svg', {
          fill: 'currentColor',
          viewBox: '0 0 24 24',
          innerHTML: '<path d="M12 2.2c3.2 0 3.6 0 4.9.1..."/>',
        })
      },
    }
  },
...
<style scoped>
/* Add any specific styles for the public theme here */
</style>